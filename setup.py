...
setup(
    name="PrjDataSci",
    version=0.1,
    description="This is a data science projet, which is intended to grow.",
    author="Adeel Ahmad",
    author_email="adeel.ahmad@univ-littoral.fr",
    url="https://github.com/Dr-Adeel/BPM_DSci.git",
    python_requires=">=3.7",
